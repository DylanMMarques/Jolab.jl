...
mls_layer = (Jolab.RoughInterface(Medium.((1, 1.5)), z, ReferenceFrame((0,0,0.0), (0,0,0.0))), 
    Propagation((ReferenceFrame((0,0,0.0), (0,0,0.0)), ReferenceFrame((0,0,100E-9), (0,0,0.0))), Medium(1.5)),
    Jolab.RoughInterface(Medium.((1.5, 2)), z, ReferenceFrame((0,0,100E-9), (0,0,0.0))),
    Propagation((ReferenceFrame((0,0,100E-9), (0,0,0.0)), ReferenceFrame((0,0,600E-9), (0,0,0.0))), Medium(2.0)),
    Jolab.RoughInterface(Medium.((2, 2.5)), z, ReferenceFrame((0,0,600E-9), (0,0,0.0))),
    Propagation((ReferenceFrame((0,0,600E-9), (0,0,0.0)), ReferenceFrame((0,0,800E-9), (0,0,0.0))), Medium(2.5)),
    Jolab.RoughInterface(Medium.((2.5, 1)), z, ReferenceFrame((0,0,800E-9), (0,0,0.0)))
)

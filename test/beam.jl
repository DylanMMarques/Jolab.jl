...
beam_spatial = Jolab.SpatialBeam(
    Jolab.Forward,
    grid_spatial,
    rand(length(x), length(x)),
    Medium(1),
...
beam_angular_gauss = Jolab.AngularSpectrum(
    Jolab.Forward,
    grid_angular_gauss,
    gaussian_angular,
    Medium(2),
...
beam_xy = Jolab.SpatialBeam(
    Jolab.Forward,
    grid_xy,
    ones(ComplexF64, 50, 50),
    Medium(1),
    ReferenceFrame((0, 0, 0), (0, 0, 0)),
)
...
beam_rθ = Jolab.SpatialBeam(
    Jolab.Forward,
    grid_rθ,
    ones(ComplexF64, 50, 49),
    Medium(1),
    ReferenceFrame((0, 0, 0), (0, 0, 0)),
)

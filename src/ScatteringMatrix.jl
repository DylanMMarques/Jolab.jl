...
@inline function light_interaction(sm::ScatteringMatrix, field_i)
    @argcheck check_same_definition(sm.field_i, field_i) ArgumentError
    _light_interaction!(sm.field_b, sm.field_f, sm, field_i)
end

@inline function ScatteringMatrix(field_b, field_f, comp, field_i)
...
@inline function ScatteringMatrix(comp, field_i)
...
@inline (*)(sm::ScatteringMatrix, field_i) = light_interaction(sm, field_i)

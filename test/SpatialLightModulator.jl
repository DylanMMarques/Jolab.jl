...
angspe = Jolab.AngularSpectrum(Float64, Forward, grid_ang, Jolab.Gaussian(10E-2), Medium(1), ReferenceFrame((0,0,0), (0,0,0)))
...
beam = Jolab.SpatialBeam(Float64, Forward, grid_spatial, Jolab.Gaussian(10E-2), Medium(1), ReferenceFrame((0,0,0), (0,0,0)))

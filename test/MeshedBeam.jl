...
beam_ang = Jolab.AngularSpectrum(
    Forward,
    grid_angular,
    e_ang,
    Medium(1),
...
beam_ang_gauss = Jolab.AngularSpectrum(
    Forward,
    grid_angular,
    gaussian,
    Medium(1),
...
beam_cyl_gauss = Jolab.SpatialBeam(
    Forward,
    grid_spatial_cyl_fine,
    gaussian_cyl,
    Medium(1),
    ReferenceFrame((0, 0, 0), (0, 0, 0)),
)
...
beam_spatial_gauss = Jolab.SpatialBeam(
    Forward,
    grid_spatial_fine,
    gaussian_spatial,
    Medium(1),
...
beam_ang_gauss_fine = Jolab.AngularSpectrum(
    Forward,
    grid_angular_fine,
    gaussian_ang,
    Medium(1),
...
beam_ang_cart = Jolab.AngularSpectrum(
    Forward,
    grid_angular_cart,
    e_cart_ang,
    Medium(1),
...
grid_angular_cart_fine =
    Jolab.CartesianGrid(Jolab.NSX_NSY_λ, nsx_fine, nsy_fine, λ_cart_ang_fine)
gaussian_cart_ang = Jolab.Gaussian(50E-6)
beam_ang_cart_gauss = Jolab.AngularSpectrum(
    Forward,
    grid_angular_cart_fine,
    gaussian_cart_ang,
    Medium(1),

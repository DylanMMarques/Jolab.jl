...
function changereferential!(fieldspace::FieldSpaceSymmetric, refnew::ReferenceFrame)
	fieldspace.ref != refnew ? error("FieldSpaceSymmetric cannot change the referential.") : nothing
end
function changereferential(fieldspace::FieldSpaceSymmetric, refnew::ReferenceFrame)::FieldSpaceSymmetric
	fieldspaceaux = deepcopy(fieldspace);
	changereferential!(fieldspaceaux, refnew);
	return fieldspaceaux;
end

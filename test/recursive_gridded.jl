...
@test_opt Jolab.lightinteraction_recursivegridded(mls_layer, beam, rtol = 1E-1, printBool = false);
...
rec_mls = (Propagation((ReferenceFrame((0,0,0.0), (0,0,0.0)), ReferenceFrame((0,0,0.1), (0,0,0))), Medium(1.0)),
    Propagation((ReferenceFrame((0,0,0.1), (0,0,0.0)), ReferenceFrame((0,0,0.5), (0,0,0))), Medium(1.0)),
           Propagation((ReferenceFrame((0,0,0.5), (0,0,0.0)), ReferenceFrame((0,0,1.0), (0,0,0))), Medium(1.0)))
(r3, t3) = Jolab.lightinteraction_recursivegridded(rec_mls, beam, rtol = 1E-20, printBool = false)
...
mls_layer = (Jolab.RoughInterface(Medium.((1, 1.5)), topography_zero, ReferenceFrame((0,0,0.0), (0,0,0.0))), 
    Propagation((ReferenceFrame((0,0,0.0), (0,0,0.0)), ReferenceFrame((0,0,100E-9), (0,0,0.0))), Medium(1.5)),
    Jolab.RoughInterface(Medium.((1.5, 2)), topography_zero, ReferenceFrame((0,0,100E-9), (0,0,0.0))),
    Propagation((ReferenceFrame((0,0,100E-9), (0,0,0.0)), ReferenceFrame((0,0,600E-9), (0,0,0.0))), Medium(2.0)),
    Jolab.RoughInterface(Medium.((2, 2.5)), topography_zero, ReferenceFrame((0,0,600E-9), (0,0,0.0))),
    Propagation((ReferenceFrame((0,0,600E-9), (0,0,0.0)), ReferenceFrame((0,0,800E-9), (0,0,0.0))), Medium(2.5)),
    Jolab.RoughInterface(Medium.((2.5, 1)), topography_zero, ReferenceFrame((0,0,800E-9), (0,0,0.0)))
)

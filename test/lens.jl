...
@test_throws ArgumentError Lens(
    1E-3,
    0.5,
    (Medium(1 + im), Medium(1.0)),
...
field = Jolab.SpatialBeam(
    ...
    rand(ComplexF64, 10, 10),
    Medium(1),
    ReferenceFrame((0, 0, 2focal_len), (0, 0, 0)),
)
@test_throws ArgumentError light_interaction(lens, field)
...
stack = DielectricStack(
    Medium.([1.0, 1.5, 1.0]),
    [500E-9],
    ReferenceFrame((0, 0, 0.002), (0, 0, 0)),
)
...
begin
    ...
    beam = Jolab.MeshedBeam{Float64,Jolab.Forward,Jolab.X_Y_λ,Jolab.PolarizationXYZ}(
        grid_xyz,
        e,
        Medium(1),
        ReferenceFrame((0, 0, 0), (0, 0, 0)),

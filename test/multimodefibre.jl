...
dir = 1
field = FieldSpaceScalar_gaussian(x, x, 50E-6, 1550E-9, 1., dir, ReferenceFrame(50E-6,0,0.))
...
dir = -1
field = FieldSpaceScalar_gaussian(x, x, 50E-6, 1550E-9, 1., dir, ReferenceFrame(50E-6,0,1))
(fieldr, fieldt) = lightinteraction(mmf, field)
